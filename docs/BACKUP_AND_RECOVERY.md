...
RPO target. The 4.5-hour figure is a maximum scheduled-start interval, not a
wall-clock measurement or a guarantee after an unsuccessful run. Daily and
monthly points are separately classified at 00:45 UTC
...
recurring production RPO. Production jitter is not measured, and persistent
catch-up is configured but not runtime-proven; deployment and external
alerting remain future operational gates.
