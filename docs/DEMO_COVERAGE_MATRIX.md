...
| Customer Quality | Quality alert | Customer Quality > Quality Alerts | APEX-QA-001 | Internal dimensional verification alert | COVERED |
| Customer Quality | 8D | Customer Quality > 8D | APEX-8D-001 | Complaint-linked 8D story | COVERED |
