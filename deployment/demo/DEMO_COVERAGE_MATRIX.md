...
| `menu_pm_qms_iso9001_transition_scenarios` — Implementation and Transition Scenarios | `pm.qms.iso9001.transition.scenario` | eight ISO 9001:2026 implementation and transition scenarios | profile, source/target edition, entry conditions, outputs and migration policy | QMS users/viewers read; administrator configuration | exactly 8 active scenarios |
