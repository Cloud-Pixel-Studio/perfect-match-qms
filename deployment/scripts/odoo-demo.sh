...
if [[ "$PMQMS_DEMO_INSTANCE" == demo2 ]]; then
  DEFAULT_DEMO_COMPANY_NAME="Apex Precision Electronics, Inc."
else
  DEFAULT_DEMO_COMPANY_NAME="Apex Precision Systems, Inc."
fi
DEMO_COMPANY_NAME="${PMQMS_DEMO_COMPANY_NAME:-$DEFAULT_DEMO_COMPANY_NAME}"
